...
const ACTION_PROMPTS = {
  ...
  profile_overview: 'You are given a fully-formed instruction describing a user\'s profile and task stats. Follow it exactly and write only the requested overview, no preamble, no markdown.'
};
